...
public class DialoguesManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Dialogues.Add(new Dialogue("Тест: питання 1", new List<Tuple<string, string>>(){
            new Tuple<string, string>("Так", "Добре, нехай буде так"), 
            new Tuple<string, string>("Ні", "Не знаю тоді як бути"), 
            new Tuple<string, string>("Не знаю", "Нахей тоді так і буде")}));
        ...
        Dialogues.Add(new Dialogue("Док: Марті, ти мене чуєш? Ти прийшов до тями?", new List<Tuple<string, string>>(){
            ...
            new Tuple<string, string>("Я... Я зовсім нічого не пам'ятаю. Де ми?", "На нас напали, бо я вкрав пляшечку львівського. Тебе вдарили по голові, і ти знепритомнів. Тому мені прийшлося тягнути тебе на спині, із-за цього я не встиг забрати більшість наших речей."), 
            new Tuple<string, string>("Ти знову щось вкрав?!", "В цьому і проблема... Я зараз тестую збільшений бак для палива, тому, через те, що на нас напали, я не встиг дозаправити Делоріан.")}));
        ...
        Dialogues.Add(new Dialogue("Док: Ти.. Ти розумієш, що це значить, Марті?", new List<Tuple<string, string>>(){
            ...
            new Tuple<string, string>("Пошкодження дуже серйозні?", "Я не можу оцінити ступінь ураження, але з виду нас може відправити не туди, куди виставлений час подорожі..")}));
        ...
        Dialogues.Add(new Dialogue("Док: Також, коли ми ще були у лабораторії, я тайкома замінив твоє взуття на інше, воно дозволяє пом'якшити падіння з висоти."));
